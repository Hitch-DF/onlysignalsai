...
class SubscriptionController extends AbstractController
{
    ...
    public function createSession(Request $request): Response
    {
        ...
        $user = $this->getUser();
        if (!$user) {
            return $this->json(['error' => 'Vous devez être connecté pour souscrire à un abonnement.'], 401);
        }
        /**@var User $user */
        try {
            ...
            $this->logger->error("Erreur lors de la création de la session d'abonnement : " . $e->getMessage());
    ...
    public function success(Request $request): Response
    {
        ...
        try {
            ...
            $this->logger->error("Erreur lors de la récupération des détails de la session : " . $e->getMessage());
